...
export default function Product() {
  return (
    <div>
      <section class="justify-center mb-20 mt-10 mx-20 dark text-neutral-500 dark:text-neutral-300">
        <div class="py-8 max-w-screen-xl mx-auto sm:py-16 lg:py-0 mb-2 ">
          ...
          <div class="grid gap-6 lg:grid-cols-3 dark lg:gap-x-12">
            <div class="mb-6 lg:mb-0">
              <div class="block h-full rounded-lg  text-white bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                ...
                <div class="p-6">
                  ...
                  <p className="text-slate-300 font-light text-sm text-justify mb-2">
                    ...
                    Enjoy essential features that streamline your workflow,
                    boost productivity, and lay the foundation for growth. With
                    a user-friendly interface and cost-effective pricing, the
                    Basic Plan is where simplicity meets functionality.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="mb-6 lg:mb-0">
              <div class="block h-full  text-white rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                <div class="border-b-2 border-neutral-100 border-opacity-100 p-6 text-center dark:border-opacity-10">
                  <p class=" text-white text-sm uppercase">
                ...
                <div class="p-6">
                  <ol class="list-inside">
                    <li class="mb-4 flex text-lg text-[17px] text-white">
                      <p>
                        Everything from{" "}
                        <span className="uppercase font-bold">premium</span>{" "}
                        plus:
                      </p>
                    </li>
                    <li class="mb-4 flex">
            ...
            <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
              <div class="mb-12 md:mb-0 ">
                ...
                <p class="text-gray-500 dark:text-gray-400 font-light mb-4">
                  ...
                  efficient. The reliability and scalability of the platform
                  make it a must-have for any IT department.
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="mb-12 md:mb-0">
                ...
                <p class="text-gray-500 dark:text-gray-400 font-light mb-4">
                  As a marketing professional, I've tried several tools, but
                  IPSUM stands out. It simplifies our campaign management, and
                  the analytics provide valuable insights. It's become an
                  essential part of our toolkit for driving results.
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 96 960 960"
                    class="inline-block w-6"
